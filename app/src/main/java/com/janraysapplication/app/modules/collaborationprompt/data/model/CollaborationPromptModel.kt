package com.janraysapplication.app.modules.collaborationprompt.`data`.model

import com.janraysapplication.app.R
import com.janraysapplication.app.appcomponents.di.MyApp
import kotlin.String

data class CollaborationPromptModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtUnleashthePow: String? =
      MyApp.getInstance().resources.getString(R.string.msg_unleash_the_pow)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtYoumaynowsta: String? =
      MyApp.getInstance().resources.getString(R.string.msg_you_may_now_sta)
