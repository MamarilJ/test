package com.janraysapplication.app.modules.submissionpromptformone.`data`.model

import com.janraysapplication.app.R
import com.janraysapplication.app.appcomponents.di.MyApp
import kotlin.String

data class SubmissionPromptFormOneModel(
  /**
  ...
  var txtDurationOne: String? =
      MyApp.getInstance().resources.getString(R.string.msg_give_us_10_minu)
